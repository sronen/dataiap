...
#plt.plot(xs_obama, ys_obama, label='Obama\'s retributions')
plt.plot(xs_mccain, ys_mccain, label='McCain\'s retributions')
plt.legend(loc='upper center', ncol = 4)
plt.savefig('test_retrib_obama_mccain.png', format='png')