...
# Correlation between YPLL and % of children eligible for free lunch
model = ols.ols(ypll_arr, measures_arr[:,12], "YPLL Rate", ["% Free lunch"]) # 12 = free lunch
model.summary()
...
subplot.scatter(measures_arr[:,12], ypll_arr, color="#1f77b4") # 12 = free lunch
subplot.set_title("ypll vs. % children eligible for free lunch")
...
plt.savefig('scatter-line-lunch.png', format='png')
